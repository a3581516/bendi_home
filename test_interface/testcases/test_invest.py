...
# @File      : unit_test_invest.py

import unittest,HTMLTestRunnerNew,json
from ddt import ddt,data,unpack
from test_interface.common.context import Context
from test_interface.common import context
from test_interface.common.http_request import HttpRequest1,HttpRequest2
from test_interface.common.doExcel import DoExcel
from test_interface.common.contants import case_file
from test_interface.common.my_log import MyLog
from test_interface.common.my_db import MyDB
import datetime
...
class TestInvest(unittest.TestCase):
    ...
    def test_invest(self, case):  ###2带session方式发起请求
        ...
        # 1） case.datas = eval(case.datas)
        # if case.datas.__contains__('mobilephone') and case.datas['mobilephone'] == 'normal_user':
        #      case.datas['mobilephone'] = config.get_str('datas','normal_user')
