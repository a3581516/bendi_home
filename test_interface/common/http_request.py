...
if __name__ == '__main__':
    ...
    # #datas='=%E6%B7%B1%E5%9C%B3&key=4a94544112eb4c0c229732187b5a47ec'
    # datas={'key':'4a94544112eb4c0c229732187b5a47ec'}
    # print(a.request('get',url,datas=datas).text)
    a=HttpRequest1()
    b = HttpRequest2()
    # 登录
    ...
    # resp1 = a.request('pOST', 'http://test.lemonban.com/futureloan/mvc/api/member/login', datas=params)
    print(resp2.text)
